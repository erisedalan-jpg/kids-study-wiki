...
- ~~英语截图裸号命名跨卷碰撞~~ ✅ 已修 2026-05-20（`exam_eng_screenshot.render_clip_series` 改 `{year}-{paper}-E{NN}.{kind}.png`；北京/湖南英语已全清重跑：55+45 md / 1123 新前缀截图 / 0 裸号残留；吉林英语是 v1 题级管线本已含年份卷别，无需重跑）
...
- **仪表盘**：`索引/吉林冲刺/` 6 张 Dataview（数学/物理/化学/生物/英语-高频50 + 总览）
