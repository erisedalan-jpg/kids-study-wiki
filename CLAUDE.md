...
- ✅ SOP 推广首步·物化生纵向贯通（2026-05-23）：`gen_strand_from_paths --subject` 从各科初高中学习路径派生递进链 + 注入，**物理0→201 / 化学0→196 / 生物1→214** 纵向覆盖；各科 `strand_map_<科>.yaml` 已建。待续：去重（各12-17组）/ 元数据主题（需各科域关键词）/ 总览视图 / 英文术语
  - 全量单测 122 过
