---
title: SSS判定
aliases: [SSS判定, SSS congruence, 三边判定, side-side-side, 全等判定, SSS]
学科: 数学
学段: [初中, 高中]
主题: [几何, 八上, 全等三角形]
状态: 全龄完成
...
- → [[152-全等三角形性质|全等三角形性质]]：全等后利用对应元素
- → [[145-SAS判定|SAS判定]]：两边夹角判定，与 SSS 配合使用
- → [[150-三角形高中线角平分线|三角形高中线角平分线]]：全等证明三线重合
